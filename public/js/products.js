class ProductManager {
    ...
    setupEventListeners() {
        ...
        if (sortSelect) sortSelect.addEventListener("change", () => this.sortProducts());
        if (btnFiltrar) btnFiltrar.addEventListener("click", () => this.applyFilters());
    }
    ...
    updateCartCount() {
        ...
        el.textContent = this.cart.reduce((total, item) => total + item.quantity, 0);
    }
